 ...
 * @author HACKER
 */
public class SystemAnomalies extends JPanel {
    ...
    public SystemAnomalies() {
        ...
        jumpToHome = new JButton(new ImageIcon(getClass().getResource("/appimages/ic_action_home.png")));
        settingsMessage = new JLabel("Settings");
        settingsLabel = new JLabel( new ImageIcon(getClass().getResource("/appimages/ic_action_settings.png")));
        helpMessage = new JLabel("Help");
        helpLabel = new JLabel( new ImageIcon(getClass().getResource("/appimages/ic_action_cv.png")));
